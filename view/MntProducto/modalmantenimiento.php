            ...
            <form method="post" id="producto_form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="prod_desc" class="form-label">Descripcion</label>
                        <textarea row="3"  class="form-control" id="prod_desc" name="prod_desc" placeholder="Ingrese Descripcion" required></textarea>
                    </div>
                </div>
